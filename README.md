...
| R50 G50 B50    R51 G51 B51    R52 G52 B52    R53 G53 B53 |                       uIndex  = (currentRow/2) * (width/2) + (currentCol/2);   // Planar
| R60 G60 B60    R61 G61 B61    R62 G62 B62    R63 G63 B63 |                       uIndex  = (currentRow/2) * width + ((currentCol/2) * 2); // Semi Planar
| R70 G70 B70    R71 G71 B71    R72 G72 B72    R73 G73 B73 |                       RIndex  = yIndex * 3 + 0;
| R80 G80 B80    R81 G81 B81    R82 G82 B82    R83 G83 B83 |                       GIndex  = yIndex * 3 + 1;
| R90 G90 B90    R91 G91 B91    R92 G92 B92    R93 G93 B93 |                       BIndex  = yIndex * 3 + 2;
|
Y
```
------------------------------------------------------------------------------------------------------
